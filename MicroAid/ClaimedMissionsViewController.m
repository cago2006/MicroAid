...
-(void)fetchMissionInfo:(int)pageNo pageSize:(int)pageSize{
    ...
    dispatch_async(kBgQueue, ^{
        NSDictionary *finishedMissions = [MicroAidAPI getMissionList2:0 recUserID:userID statusList:statusArray longitude:longitude latitude:latitude pageNo:pageNo pageSize:pageSize];
