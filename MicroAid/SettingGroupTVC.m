...
@interface SettingGroupTVC ()

@end

@implementation SettingGroupTVC
...
- (void)viewDidLoad {
    ...
    for(int j = 0; j<self.dataArray.count; j++){
        if([self.groupString isEqualToString:[self.dataArray objectAtIndex:j]]){
...
-(void) returnToSetting{
    ...
    if (deleteSpecificRows)
    {
        ...
        mySettingVC.missionGroup = choosed;
