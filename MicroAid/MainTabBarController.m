...
- (void)viewDidLoad {
    ...
    missionNav.title = [NSString stringWithFormat:@"%@",Localized(@"任务")];
    ...
    groupNav.title = [NSString stringWithFormat:@"%@",Localized(@"群组")];;
    ...
    notifyNav.title = [NSString stringWithFormat:@"%@",Localized(@"通知")];
    ...
    mineNav.title = [NSString stringWithFormat:@"%@",Localized(@"我")];
    ...
    rankNav.title = [NSString stringWithFormat:@"%@",Localized(@"排行")];
