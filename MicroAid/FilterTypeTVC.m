...
@interface FilterTypeTVC ()

@end

@implementation FilterTypeTVC
...
- (void)returnToFilter
{
    ...
    if (deleteSpecificRows)
    {
        ...
        self.returnFilterTypeDelegate = fVC;
        [self.returnFilterTypeDelegate passFilterTypeValues:choosed];
        ...
        self.returnFilterTypeDelegate = fVC;
        [self.returnFilterTypeDelegate passFilterTypeValues:@""];
